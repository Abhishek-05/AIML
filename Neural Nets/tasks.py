...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.1, 10, 500)
...
def taskMnist():
	...
	#raise NotImplementedError
	nn1 = nn.NeuralNetwork(10, 0.2, 10, 100)
	nn1.addLayer(FullyConnectedLayer(784,25))
...
def taskCifar10():	
	...
	# # Eg. nn1.addLayer(FullyConnectedLayer(x,y))
	# ###############################################
	nn1 = nn.NeuralNetwork(10, 0.1, 1, 13)
	nn1.addLayer(ConvolutionLayer([3,32,32], [10,10], 3, 2))
	# nn1.addLayer(AvgPoolingLayer([20,12,12], [4,4], 4))
	nn1.addLayer(FlattenLayer())
	nn1.addLayer(FullyConnectedLayer(3*144,60))
